...
- [[jsons] Remove empty keys and made them not compulsory](https://github.com/BEComTweaks/resource-packs/pull/31) on [BEComTweaks/resource-packs](https://github.com/BEComTweaks/resource-packs) (1 week ago)
- [fixed server from erroring out when undefined var](https://github.com/BEComTweaks/server-backend/pull/10) on [BEComTweaks/server-backend](https://github.com/BEComTweaks/server-backend) (1 week ago)
- [[chore] Take stuff from RP](https://github.com/BEComTweaks/crafting-tweaks/pull/2) on [BEComTweaks/crafting-tweaks](https://github.com/BEComTweaks/crafting-tweaks) (1 week ago)
