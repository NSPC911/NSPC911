...
- [NSPC911/human-errors](https://github.com/NSPC911/human-errors) - everyone makes mistakes, show the errors to them (3 days ago)
- [NSPC911/rovr](https://github.com/NSPC911/rovr) - A post-modern terminal file manager. (4 days ago)

#### 🔨 My recent Pull Requests!

- [feat(geometry): add support for css three value format](https://github.com/Textualize/textual/pull/6231) on [Textualize/textual](https://github.com/Textualize/textual) (4 days ago)
- [fix: add set_options to SelectionList](https://github.com/Textualize/textual/pull/6224) on [Textualize/textual](https://github.com/Textualize/textual) (1 week ago)
- [feat(app): add a state manager](https://github.com/NSPC911/rovr/pull/146) on [NSPC911/rovr](https://github.com/NSPC911/rovr) (1 week ago)
